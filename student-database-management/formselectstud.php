...
<html>
<head>
	<title>formselect student</title>
...
<body>
<div class="container">
  <form class="form-signin" method="POST" action="s-select.php">
     <center> <h3 style="font-size:35px;"><b> Student Details Delete</b></h3></center>
